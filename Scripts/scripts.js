		...
		if(cart) {
			...
			jQuery.each(cart.items,function(i,item){
				...
				if(item.image != null)
					...
					tr.find('.item-image').html("<img src='//theme.hstatic.net/200000104195/1000677830/14/no_image.jpg?v=336'>");
...
function clone_item(product,i){
	...
	if ( product.image == null ) {
		item_product.find('img').attr('src','//theme.hstatic.net/200000104195/1000677830/14/no_image.jpg?v=336').attr('alt', product.url);
	} else {
...
$('.mb-menu li.has-sub>a').click(function(e){
e.preventDefault();
